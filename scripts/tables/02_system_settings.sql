...
CREATE TABLE IF NOT EXISTS system_settings (
    ...
    default_customer_parent_account VARCHAR(50) DEFAULT '',
    default_customer_credit_account VARCHAR(50) DEFAULT '',
    default_sales_tax_account VARCHAR(50) DEFAULT '',
    default_currency_transfer_account VARCHAR(50) DEFAULT '',
    default_earned_discount_account VARCHAR(50) DEFAULT '',
    default_exchange_gain_loss_account VARCHAR(50) DEFAULT '',
    default_salesman_parent_account VARCHAR(50) DEFAULT '',
    default_supplier_parent_account VARCHAR(50) DEFAULT '',
    default_customer_subscription_account VARCHAR(50) DEFAULT '',
    default_purchase_tax_account VARCHAR(50) DEFAULT '',
    default_new_employee_account VARCHAR(50) DEFAULT '',
    default_allowed_discount_account VARCHAR(50) DEFAULT '',
