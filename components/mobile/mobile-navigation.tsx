      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-background border-b border-border px-4 py-3">
        <div className="flex items-center justify-between" dir="rtl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-foreground">ARAAK ERP System</h1>
            </div>
          </div>
              ...
              <SheetContent side="right" className="w-80 p-0" dir="rtl">
                <div className="p-6 border-b border-border bg-primary">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-semibold text-white">ARAAK ERP System</h2>
                      <p className="text-xs text-primary-foreground/80">ARAAK ERP System</p>
                    </div>
                  </div>
                </div>
