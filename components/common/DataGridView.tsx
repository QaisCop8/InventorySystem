      ...
      <div style={height}>
        {this.state.hasError && (
          <div className="p-4 bg-red-50 border border-red-200 rounded text-sm text-red-700">
            <strong>ط®ط·ط£ ظپظٹ طھط­ظ…ظٹظ„ ط§ظ„ط¬ط¯ظˆظ„</strong>
...
createButtonTemplate = (col) => (ctx) => {
  ...
  printDoc() {
    ...
    doc.append('<h1>ظ‚ط§ط¦ظ…ط© ط§ظ„ظ…ظˆط¸ظپظٹظ†</h1>');
    doc.append('</div>');
    doc.append('<div style="direction:' + dir + '">');
    doc.append('<p> ظ‚ط§ط¦ظ…ط© ط§ظ„ظ…ظˆط¸ظپظٹظ† ط§ظ„ط®ط§طµط©<b> ط¨ط´ط±ظƒط© ط§ط³ط±ط§ط، ظ„ظ„ط¨ط±ظ…ط¬ط© ظˆط§ظ„ظƒظ…ط¨ظٹظˆطھط± </b></p>');
    // add a printer-friendly version of a FlexGrid to the document
    doc.append('<p>ظ†ط§ط¨ظ„ط³ ط´ط§ط±ط¹ ظپظٹطµظ„ ظ‡ط§طھظپ 2373001 ظپط§ظƒط³ 2373002</p>');
    doc.append('</div>');
...
const normalizeArabic = (text) => {
  ...
  return text
    ...
    .replace(/(ط¤|ظˆ)/g, 'ظˆ')
    .replace(/(ظ‰|ظٹ|ط¦)/g, 'ظٹ')
    .replace(/[ظژظ‹ظڈظŒظگظچظ’]/g, '')
    .replace(/[ظ ظ،ظ¢ظ£ظ¤ظ¥ظ¦ظ§ظ¨ظ©]/g, (d) => '0123456789'['ظ ظ،ظ¢ظ£ظ¤ظ¥ظ¦ظ§ظ¨ظ©'.indexOf(d)]);
};
